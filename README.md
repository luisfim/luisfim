...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,py,linux,bash,git,vscode,arduino,html,js,css,aws,bots,figma,md,notion,obsidian,ps,pr,raspberrypi)](https://skillicons.dev)
